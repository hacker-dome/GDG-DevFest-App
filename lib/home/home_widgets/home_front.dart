        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
              ...
              onPressed: () async {
                await _launchURL("https://www.facebook.com/gdgcusco");
              },
            ),
            //IconButton(
            ...
            IconButton(
              ...
              onPressed: () async {
                await _launchURL("https://www.meetup.com/gdgcuscoperu/");
              },
            ),
            IconButton(
              ...
              onPressed: () async {
                var emailUrl =
                    '''mailto:gdgcusco@gmail.com?subject=Support Needed For DevFest App&body={Name: GDG Cusco}''';
